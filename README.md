...
> **TODO（发布前完成）**：用 ShareX / ScreenToGif 截取三张图放入 `docs/` 目录，
> 然后取消下方注释并提交。建议内容：① 三栏浏览与三段式详情页 ② 抽题自测翻卡流程
> ③ 设置页 AI 批处理进度条。

<!--
| 三栏浏览 · 三段式框架 | 抽题自测 | AI 批处理 |
| :---: | :---: | :---: |
| ![浏览](docs/preview-browse.png) | ![自测](docs/preview-quiz.png) | ![批处理](docs/preview-settings.png) |
-->
